...
def _apply_remap(df: pd.DataFrame) -> pd.DataFrame:
    ...
    (returns FX_BASIS_LABEL='FX Basis Risk & Carry' for FX rows)."""
    out = df.copy()
...
CSS = PA_FX_SPLIT_CSS_BASE + """.pa-toolbar-mini { display:flex; justify-content:flex-end; gap:8px; margin-bottom:6px; align-items:center }
